...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		DrawOver(over1, worldViewProjectionMatrix, viewportMatrix, colorS1);
		DrawOver(over2, worldViewProjectionMatrix, viewportMatrix, colorS2);

		ImGui::Begin("Debug");
		ImGui::DragFloat3("cameraTRa", &cameraTranslate.x, 0.1f, -50.0f, 50.0f);
		ImGui::DragFloat3("cameraRot", &cameraRotate.x, 0.1f, -50.0f, 50.0f);

		ImGui::DragFloat3("Over1min", &over1.min.x, 0.1f, -1.0f, 5.0f);
		ImGui::DragFloat3("Over1max", &over1.max.x, 0.1f, -1.0f, 5.0f);
		ImGui::DragFloat3("Over2min", &over2.min.x, 0.1f, -1.0f, 5.0f);
		ImGui::DragFloat3("Over2max", &over2.max.x, 0.1f, -1.0f, 5.0f);
		ImGui::End();
		///
		/// ↑描画処理ここまで
		///
